...
def get_results():
    ...
    pretrained_model.load_state_dict(torch.load("/home/clydechx/FairFace/celebA_model.pt",map_location=device))
    dataset_dir= '/home/clydechx/FairFace/mydataset/celeba/img_align_celeba'
    image_paths = get_image_paths(dataset_dir)
    to_visual = {'layer2.1.relu': {19: 0.010016610459556048, 50: 0.0101676146373383}, 'layer2.2.relu': {60: 0.016107112296773543}, 'layer2.3.relu': {60: 0.029093471586047213, 105: 0.04817033271253838}, 'layer3.0.relu': {43: 0.070317612120602, 121: 0.03568732068253888, 144: 0.02612372275632959}, 'layer3.1.relu': {118: 0.015452760859717118, 144: 0.18533246086475058, 146: 0.1447123370413248, 151: 0.11889062264055972, 161: 0.0679518800020134, 180: 0.06598882569084412, 197: 0.044244224090199825, 251: 0.03875773896411134}, 'layer3.2.relu': {91: 0.016409120652338047, 118: 0.01847284441536216, 151: 0.037197362460361406, 161: 0.14274928273015552, 225: 0.03473096088991796}, 'layer3.3.relu': {161: 0.030402174460160063}, 'layer4.0.relu': {122: 0.010771631348467307, 300: 0.014546735793023607}}
